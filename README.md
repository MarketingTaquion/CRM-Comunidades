...
## Medición y cohortes (2026-09-24)

Reunión Jazleidis/Juan (2026-09-23) reencuadró la prioridad hacia el flujo de métricas y cohortes, por delante de Activaciones avanzadas (Fase 4, que queda diferida). Detalle completo, decisiones de alcance y diseño en [`specs/2026-09-24-medicion-y-cohortes.md`](specs/2026-09-24-medicion-y-cohortes.md).

- **Qué se construyó:** [`db/008_metrica_semanal.sql`](db/008_metrica_semanal.sql) — tabla `metrica_semanal`, una foto guardada por comunidad/corredor/semana (no un cálculo al vuelo), con campos auto-calculables (contactos nuevos/activos/dados de baja, engagement, abandono, referidos) y campos de carga manual aparte (inversión en pauta, CPL, conversaciones Meta, clics — sin integrar con Pulso Ignite en esta fase). En el panel, un botón "Guardar foto de esta semana" en Overview calcula lo automático y deja cargar lo manual.
- **Qué queda para después:** la vista de cohortes (retención semana a semana por corredor) se termina de diseñar cuando haya al menos unas semanas de fotos reales cargadas — construirla antes sería diseñar en el vacío.
